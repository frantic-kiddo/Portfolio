...
interface HoverSliderTextProps {
  index: number
}
        ...
        >
          ...
          >
            ...
            <motion.span
              ...
              animate={
                isActive ? { y: "0%", opacity: 1 } : { y: "110%", opacity: 0 }
              }
            >
              {char}
            </motion.span>
...
export const HoverSliderText = React.forwardRef<
  HTMLDivElement,
  HTMLMotionProps<"div"> & HoverSliderTextProps
...
HoverSliderText.displayName = "HoverSliderText"
