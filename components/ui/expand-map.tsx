...
export function LocationMap({
  ...
  return (
    ...
    >
      <motion.div
        className="relative overflow-hidden rounded-2xl border border-border bg-transparent"
        style={{
      ...
      >
        ...
        <div className="relative z-10 flex h-full flex-col justify-between p-5">
          ...
          <div className="space-y-1">
            ...
            <motion.div
              className="h-px bg-gradient-to-r from-white/70 via-white/40 to-transparent"
