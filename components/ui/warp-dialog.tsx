...
function WarpAnimations() {
  ...
  return (
    <>
      ...
      />
      <motion.div
        className="absolute left-[-50%] top-[-25%] h-full w-full rounded-full bg-red-500/90 blur-[100px]"
        initial={{ opacity: 0 }}
        animate={{
          opacity: 0.9,
          transition: {
      ...
      />
      <motion.div
        className="absolute left-[50%] top-[25%] h-full w-full rounded-full bg-red-500/80 blur-[100px]"
        initial={{ opacity: 0 }}
        animate={{
          opacity: 0.9,
          transition: {
